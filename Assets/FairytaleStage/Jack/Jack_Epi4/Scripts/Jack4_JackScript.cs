 ...
 * 
 * - Content :
 * 잭과콩나무 에피소드4 - Jack 스크립트(대사) 관리 스크립트
 * 
 * - Update Log -
 * 2021-07-14 : 제작 완료
 * 2021-07-23 : 주석 변경
...
/// <summary>
/// Jack 스크립트를 관리해주는 스크립트, 내용을 공백으로, 다음내용을 출력할수 있다.
/// </summary>
public class Jack4_JackScript : MonoBehaviour
{
    ...
    private string ms_ScriptText = "어머니 젖소를 마술 콩이랑 바꾸었어요.";
    ...
    void Start()
    {
        this.mg_JackScript = GameObject.Find("JackScript");   //스크립트 오브젝트 연결
